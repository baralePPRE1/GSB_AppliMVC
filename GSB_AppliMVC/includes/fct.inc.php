 ...
 * @param String $typePersonnel   Fonction du visiteur
 * @return null
 */
...
/**
 * Enregistre dans une variable les infos d'un visiteur medical
 *
 * @param String $id              ID du visiteur medical
 * @param String $nom             Nom du visiteur medical
 * @param String $prenom          Prénom du visiteur medical
 * @return null
 */
function getLesInfosdunVisiteurMedical($id, $nomduvm, $prenomduvm)
{
    $leVisiteuraValider['idVisiteur'] = $id;
    $leVisiteuraValider['nom'] = $nomduvm;
    $leVisiteuraValider['prenom'] = $prenomduvm;
}
/**
